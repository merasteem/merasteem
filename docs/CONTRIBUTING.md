## Contributing to Merasteem

Want to get involved in Merasteem development? Thanks! There are plenty of ways you can help!
...
The [issue tracker](https://github.com/merasteem/merasteem/issues) is the preferred channel
...
[good first issues](https://github.com/merastem/merasteem/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
or list of [help wanted issues](https://github.com/merasteem/merasteem/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22).
...
After some time (it can take few minutes) you should be able to see Merasteem running at http://localhost:3000
