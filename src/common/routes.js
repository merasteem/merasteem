...
import MeraProjects from '../client/user/MeraProjects';
...
const routes = [
  {
    ...
    routes: [
      ...
      {
        path: '/@:name/(merasteem|comments|followers|followed|reblogs|feed|transfers|activity)?',
        component: User,
        exact: true,
        routes: [
          {
