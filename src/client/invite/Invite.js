  ...
  render() {
    ...
    return (
      <div className="shifted">
        <Helmet>
          <title>{intl.formatMessage({ id: 'invite', defaultMessage: 'Invite' })} - Merasteem</title>
        </Helmet>
          ...
          <div className="center">
            <div className="Invite">
              ...
              <h1 className="Invite__title">
                <FormattedMessage id="invite_title" defaultMessage="Don't use Merasteem alone!" />
              </h1>
              <p className="Invite__description">
                <FormattedMessage
                  id="invite_info"
                  defaultMessage="Onboard new users on Merasteem today using the link below and get 10% of their rewards for 30 days."
                />
              </p>
              ...
              <div className="Invite__social">
                ...
                <TwitterShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on merasteem.com and get rewarded to blog {link}',
                    },
                    {
                      link: '',
                    },
