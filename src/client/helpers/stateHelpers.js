export const getFeedFromState = (sortBy, category = 'merasteem', state) => {
  switch (sortBy) {
    case 'feed':
    case 'hot':
    case 'created':
...
export const getFeedLoadingFromState = (sortBy, category = 'merasteem', feedState) => {
  switch (sortBy) {
    case 'feed':
    case 'hot':
    case 'created':
...
export const getFeedFetchedFromState = (sortBy, category = 'merasteem', feedState) => {
  switch (sortBy) {
    case 'feed':
    case 'hot':
    case 'created':
...
export const getFeedHasMoreFromState = (sortBy, listName = 'merasteem', feedState) => {
  switch (sortBy) {
    case 'feed':
    case 'hot':
    case 'cashout':
...
export const getFeedFailedFromState = (sortBy, listName = 'merasteem', feedState) => {
  switch (sortBy) {
    case 'feed':
    case 'hot':
    case 'cashout':
 ...
 * @param {Object} commentsState - state.comments in merasteem redux setup
