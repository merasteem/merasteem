...
export const getFeedContent = ({ sortBy = 'created', category ='merasteem', limit = 20 }) => (
  dispatch,
  getState,
  { steemAPI },
) =>
  dispatch({
    ...
    meta: {
      sortBy,
      category: category || 'merasteem',
      limit,
    },
  });

export const getMoreFeedContent = ({ sortBy, category = 'merasteem', limit = 20 }) => (
  dispatch,
  getState,
  { steemAPI },
) => {
