...
export const sendComment = (parentPost, body, isUpdating = false, originalComment) => (
  ...
  const newBody = isUpdating ? getBodyPatchIfSmaller(originalComment.body, body) : body + '<br/><div class="pull-right promo"><sub>' +'<p>This comment was made from <a href="https://www.merasteem.com" target="_blank">Merasteem</a></p></sub></div>';
