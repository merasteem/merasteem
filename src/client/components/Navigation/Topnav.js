        ...
        <div className="topnav-layout">
          <div className={classNames('left', { 'Topnav__mobile-hidden': searchBarActive })}>
            <Link className="Topnav__brand" to="/">
              <img src="https://cdn.steemitimages.com/DQmZbveGuVifWvZ9hKs3JtiA4CvbkhwU4gWbMKe64oRWAkh/merasteem_logo_full_main_banner-01.png" alt="Merasteem Logo" className="Topnav__logo" />
            </Link>
          </div>
